...
function deepExtend(destination, ...sources) {
	for (const source of sources) {
		...
		const sourceKeys = Object.keys(source), dangerousKeys = /* @__PURE__ */ new Set([
			"__proto__",
			"constructor",
			"prototype"
		]);
...
var Engine = class {
	...
	async load(params) {
		...
		const { Container } = await import("./Container-DnZiIWXf.js"), id = params.id ?? domSourceElement?.id ?? `tsparticles${Math.floor(getRandom() * 1e4).toString()}`, { index, url } = params, currentOptions = itemFromSingleOrMultiple(url ? await getDataFromUrl({
...
//#endregion
export { defaultTransform as $, getDistance as A, parseAlpha as B, OutModeDirection as C, checkDistance as D, cancelAnimation as E, getRandomInRange as F, isNull as G, setRangeValue as H, getRangeMax as I, isString as J, isNumber as K, getRangeMin as L, getParticleBaseVelocity as M, getParticleDirectionAngle as N, clamp as O, getRandom as P, defaultCompositeValue as Q, getRangeValue as R, PixelMode as S, calcExactPositionOrRandomFromSize as T, isArray as U, randomInRangeValue as V, isBoolean as W, Vector3d as X, Vector as Y, MoveDirection as Z, itemFromSingleOrMultiple as _, circleBounce as a, randomColorValue as at, safeMatchMedia as b, deepExtend as c, getItemMapFromInitializer as d, doublePI as et, getItemsFromInitializer as f, itemFromArray as g, isPointInside as h, calculateBounds as i, originPoint as it, getDistances as j, degToRad as k, executeOnSingleOrMultiple as l, isInArray as m, getLogger as n, half as nt, circleBounceDataFromParticle as o, resizeEvent as ot, getPosition as p, isObject as q, EventType as r, millisecondsToSeconds as rt, cloneStyle as s, visibilityChangeEvent as st, tsParticles as t, generatedAttribute as tt, getFullScreenStyle as u, manageListener as v, animate as w, safeMutationObserver as x, safeDocument as y, mix as z };
