    ...
    <div className="relative min-h-screen bg-white text-gray-800 overflow-x-hidden">
      ...
      <header className={`fixed top-0 left-0 right-0 z-50 flex justify-between items-center px-8 py-4 transition-all duration-500 ${headerScrolled
        ...
        <div className="logo flex items-center">
          ...
          <img src={logo} alt="Logo GSAPLATFORM" className='w-6 h-6' />
          <span className={`titleLogo ml-3 text-2xl font-bold ${headerScrolled ? ' titleLogo text-gray-800' : 'text-white drop-shadow-md'}`}>
            GSAPLATFORM
          </span>
        </div>
        <nav>
          ...
          <div className="flex flex-col md:flex-row justify-between items-start">
            <div className="mb-8 md:mb-0">
              ...
              <div className="flex items-center mb-4">
                ...
                <span className="ml-3 text-xl font-bold">GSAPLATFORM</span>
              </div>
              <p className="text-gray-400 mb-2">gsaplatform@gsaplatform.co</p>
            ...
            <div className="text-right">
              ...
              <p className="text-gray-300">Avenida Pedro de Castro Van Dúnem Loy</p>
              <p className="text-gray-300">Condominio Royal Park, Edificio 1, 3º Andar, Talatona</p>
              <p className="text-gray-300">Luanda-Angola</p>
              <p className="text-gray-300 mt-2">+244923652110</p>
            </div>
          </div>

          <div className="mt-12 pt-6 border-t border-gray-800 text-center text-gray-500">
            <p>© 2025 GSAPLATFORM. Todos os direitos reservados.</p>
          </div>
        </div>
      </footer>
    </div>
